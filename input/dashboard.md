...
| [Qpid JMS]({{site_url}}/components/jms/index.html)                         | {{jms_release.brief_link}} | {{dashboard_asf_jira_links("QPIDJMS", 12314524)}} | {{github_ci_badge("qpid-jms")}} | {{dashboard_asf_git_links("qpid-jms")}} |
...
| [Qpid Proton-J]({{site_url}}/proton/index.html)                            | {{proton_j_release.brief_link}} | {{dashboard_asf_jira_links("PROTON", 12313720, ["proton-j"])}} | {{github_ci_badge("qpid-proton-j")}} | {{dashboard_asf_git_links("qpid-proton-j")}} |
...
### Issues
 ...
 - [All Qpid issues](https://issues.apache.org/jira/issues/?jql=project%20in%20\(QPID%2C%20QPIDIT%2C%20QPIDJMS%2C%20PROTON\))
