...
jms_release = _Release(site_url, "Qpid JMS", "qpid-jms", "2.1.0")
other_jms_release = "1.7.0"
jms_amqp_0_x_release = _Release(site_url, "Qpid JMS for AMQP 0-x", "qpid-jms-amqp-0-x", "6.4.0")
proton_release = _Release(site_url, "Qpid Proton", "qpid-proton", "0.37.0")
proton_j_release = _Release(site_url, "Qpid Proton-J", "qpid-proton-j", "0.34.0")
protonj2_release = _Release(site_url, "Qpid ProtonJ2", "qpid-protonj2", "1.0.0-M9")
python_release = _Release(site_url, "Qpid Python", "qpid-python", "1.37.0")
proton_dotnet_release = _Release(site_url, "Qpid Proton DotNet", "qpid-proton-dotnet", "1.0.0-M4")
