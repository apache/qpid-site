...
broker_j_release = _Release(site_url, "Qpid Broker-J", "qpid-broker-j", "7.0.4")
cpp_release = _Release(site_url, "Qpid C++", "qpid-cpp", "1.38.0")
dispatch_release = _Release(site_url, "Qpid Dispatch", "qpid-dispatch", "1.1.0")
...
jms_release = _Release(site_url, "Qpid JMS", "qpid-jms", "0.32.0")
jms_amqp_0_x_release = _Release(site_url, "Qpid JMS for AMQP 0-x", "qpid-jms-amqp-0-x", "6.3.1")
proton_release = _Release(site_url, "Qpid Proton", "qpid-proton", "0.23.0")
proton_j_release = _Release(site_url, "Qpid Proton-J", "qpid-proton-j", "0.27.1")
