...
broker_j_release = _Release(site_url, "Qpid Broker-J", "qpid-broker-j", "7.1.6")
other_broker_j_release = "7.0.8"
...
jms_release = _Release(site_url, "Qpid JMS", "qpid-jms", "0.48.0")
