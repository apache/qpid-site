...
jms_release = _Release(site_url, "Qpid JMS", "qpid-jms", "0.28.0")
jms_amqp_0_x_release = _Release(site_url, "Qpid JMS for AMQP 0-x", "qpid-jms-amqp-0-x", "6.3.0")
proton_release = _Release(site_url, "Qpid Proton", "qpid-proton", "0.19.0")
proton_j_release = _Release(site_url, "Qpid Proton-J", "qpid-proton-j", "0.25.0")
