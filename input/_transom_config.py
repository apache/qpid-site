...
broker_j_release = _Release(site_url, "Qpid Broker-J", "qpid-broker-j", "7.1.5")
...
jms_release = _Release(site_url, "Qpid JMS", "qpid-jms", "0.46.0")
...
proton_j_release = _Release(site_url, "Qpid Proton-J", "qpid-proton-j", "0.33.2")
