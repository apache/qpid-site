...
dispatch_release = _Release(site_url, "Qpid Dispatch", "qpid-dispatch", "1.13.0")
interop_test_release = _Release(site_url, "Qpid Interop Test", "qpid-interop-test", "0.2.0")
jms_release = _Release(site_url, "Qpid JMS", "qpid-jms", "0.54.0")
jms_amqp_0_x_release = _Release(site_url, "Qpid JMS for AMQP 0-x", "qpid-jms-amqp-0-x", "6.4.0")
proton_release = _Release(site_url, "Qpid Proton", "qpid-proton", "0.31.0")
proton_j_release = _Release(site_url, "Qpid Proton-J", "qpid-proton-j", "0.33.6")
