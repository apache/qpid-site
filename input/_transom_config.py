...
broker_j_release = _Release(site_url, "Qpid Broker-J", "qpid-broker-j", "9.0.0")
...
jms_release = _Release(site_url, "Qpid JMS", "qpid-jms", "2.3.0")
other_jms_release = "1.10.0"
...
protonj2_release = _Release(site_url, "Qpid ProtonJ2", "qpid-protonj2", "1.0.0-M15")
python_release = _Release(site_url, "Qpid Python", "qpid-python", "1.37.0")
proton_dotnet_release = _Release(site_url, "Qpid Proton DotNet", "qpid-proton-dotnet", "1.0.0-M9")
