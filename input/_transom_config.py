...
broker_j_release = _Release(site_url, "Qpid Broker-J", "qpid-broker-j", "10.0.0")
...
jms_release = _Release(site_url, "Qpid JMS", "qpid-jms", "2.9.0")
other_jms_release = "1.15.0"
...
protonj2_release = _Release(site_url, "Qpid ProtonJ2", "qpid-protonj2", "1.0.0")
