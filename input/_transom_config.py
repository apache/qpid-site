...
broker_j_release = _Release(site_url, "Qpid Broker-J", "qpid-broker-j", "7.1.2")
other_broker_j_release = "7.0.7"
cpp_release = _Release(site_url, "Qpid C++", "qpid-cpp", "1.39.0")
dispatch_release = _Release(site_url, "Qpid Dispatch", "qpid-dispatch", "1.6.0")
...
proton_release = _Release(site_url, "Qpid Proton", "qpid-proton", "0.27.0")
proton_j_release = _Release(site_url, "Qpid Proton-J", "qpid-proton-j", "0.32.0")
