...
broker_j_release = _Release(site_url, "Qpid Broker-J", "qpid-broker-j", "9.2.0")
...
jms_release = _Release(site_url, "Qpid JMS", "qpid-jms", "2.5.0")
other_jms_release = "1.11.0"
jms_amqp_0_x_release = _Release(site_url, "Qpid JMS for AMQP 0-x", "qpid-jms-amqp-0-x", "6.4.0")
proton_release = _Release(site_url, "Qpid Proton", "qpid-proton", "0.39.0")
proton_j_release = _Release(site_url, "Qpid Proton-J", "qpid-proton-j", "0.34.1")
protonj2_release = _Release(site_url, "Qpid ProtonJ2", "qpid-protonj2", "1.0.0-M21")
python_release = _Release(site_url, "Qpid Python", "qpid-python", "1.37.0")
proton_dotnet_release = _Release(site_url, "Qpid Proton DotNet", "qpid-proton-dotnet", "1.0.0-M10")
