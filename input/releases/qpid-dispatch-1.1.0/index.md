...
|---------|----------|--------|
| Dispatch router | [qpid-dispatch-1.1.0.tar.gz](http://archive.apache.org/dist/qpid/dispatch/1.1.0/qpid-dispatch-1.1.0.tar.gz) | [ASC](https://archive.apache.org/dist/qpid/dispatch/1.1.0/qpid-dispatch-1.1.0.tar.gz.asc), [SHA512](https://archive.apache.org/dist/qpid/dispatch/1.1.0/qpid-dispatch-1.1.0.tar.gz.sha512) |
...
<script type="text/javascript">
  _deferredFunctions.push(function() {
      if ("1.1.0" === "{{current_dispatch_release}}") {
