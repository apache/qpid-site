...
|---------|----------|--------|
| Qpid Proton | [qpid-proton-0.22.0.tar.gz](http://archive.apache.org/dist/qpid/proton/0.22.0/qpid-proton-0.22.0.tar.gz) | [ASC](https://archive.apache.org/dist/qpid/proton/0.22.0/qpid-proton-0.22.0.tar.gz.asc), [SHA512](https://archive.apache.org/dist/qpid/proton/0.22.0/qpid-proton-0.22.0.tar.gz.sha512) |
...
;; - [Go binding](https://github.com/apache/qpid-proton/tree/master/proton-c/bindings/go/README.md)
 - [Installing Qpid Proton](https://git-wip-us.apache.org/repos/asf?p=qpid-proton.git;a=blob;f=INSTALL.md;hb=0.22.0)
...
<script type="text/javascript">
  _deferredFunctions.push(function() {
      if ("0.22.0" === "{{current_proton_release}}") {
