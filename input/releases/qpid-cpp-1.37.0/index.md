...
|---------|----------|--------|
| C++ broker, Qpid Messaging API (C++) | [qpid-cpp-1.37.0.tar.gz](http://archive.apache.org/dist/qpid/cpp/1.37.0/qpid-cpp-1.37.0.tar.gz) | [ASC](http://archive.apache.org/dist/qpid/cpp/1.37.0/qpid-cpp-1.37.0.tar.gz.asc), [MD5](http://archive.apache.org/dist/qpid/cpp/1.37.0/qpid-cpp-1.37.0.tar.gz.md5), [SHA512](http://archive.apache.org/dist/qpid/cpp/1.37.0/qpid-cpp-1.37.0.tar.gz.sha512) |
...
## More information
 ...
 - [Source repository tag](https://git-wip-us.apache.org/repos/asf/qpid-cpp.git/tree/refs/tags/1.37.0)
